 ...
 */
public class LTSOriginalBinaryClassification {
    ...
    public void Initialize() throws FileNotFoundException {
        ...
        if (K < 0)
            K = 10;//(int) Math.log(totalSegments) * (C - 1);
...
//                    previousLoss = lossHistory.get(iter);
//                    flag = 1;
//                }
//                else if(flag == 1){
//                    previousLoss = lossHistory.get(iter);
//                    if (previousLoss>lossTrain)
//                        lossHistory.add(lossTrain);
//                    else
//                        break;	
//                }
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        String maindirectory = "/home/a3d/Desktop/Shoumik_experiments/dataset/ECML2020/synthetic/binary/";
        ...
        for (String name : datasets) {
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LTSOriginalBinaryClassification lso = new LTSOriginalBinaryClassification();
