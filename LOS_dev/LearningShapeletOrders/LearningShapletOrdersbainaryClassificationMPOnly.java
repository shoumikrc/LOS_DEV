...
public class LearningShapletOrdersbainaryClassificationMPOnly {
...
//	}
    ...
    public static void main(String [] args) throws FileNotFoundException, IOException{
        ...
        System.out.println("LSO for Binary Classification with MP Only");
        ...
        for(String name : datasets){
            ...
            for(long seed = 0;seed<numofSeeds;seed++ ){
                ...
                //Java class object
                LearningShapletOrdersbainaryClassificationMPOnly lso = new LearningShapletOrdersbainaryClassificationMPOnly(); 
                //lso.runPython();
