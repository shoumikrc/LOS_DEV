 ...
 */
public class LearningShapeletOrdersMPOnly {
...
//	}
    ...
    public static void main(String [] args) throws FileNotFoundException, IOException{
        System.out.println("LSO MP Only");
        //main outer directory for Dataset Selection
        String maindirectory = "C:\\shoumik\\DABI\\datasets\\TSCProblems2018\\Univariate2018_arff\\analyze\\";
        ...
        for(String name : datasets){
            ...
            String outfile = place +name +"_LearnOrders_MP_Only_Results.txt";
            ...
            for(long seed = 0;seed<numofSeeds;seed++ ){
                ...
                //Java class object
                LearningShapeletOrdersMPOnly lso = new LearningShapeletOrdersMPOnly(); 
