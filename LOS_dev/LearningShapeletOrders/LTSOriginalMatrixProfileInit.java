 ...
 */
public class LTSOriginalMatrixProfileInit {
    ...
    public static void main(String [] args) throws FileNotFoundException, IOException{
        System.out.println("LTS with MP_INIT");
        //main outer directory for Dataset Selection
        String maindirectory = "C:\\shoumik\\DABI\\datasets\\TSCProblems2018\\experiment\\SENSOR\\";
        ...
        for(String name : datasets){
            ...
            String trainingFileName = place+name+"_TRAIN.txt";
            ...
            for(long seed = 0;seed<numofSeeds;seed++ ){
                ...
                //Java class object
                LTSOriginalMatrixProfileInit lso = new LTSOriginalMatrixProfileInit(); 
                lso.trainingFileName = trainingFileName;
