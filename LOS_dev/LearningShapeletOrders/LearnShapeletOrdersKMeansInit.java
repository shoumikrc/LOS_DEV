...
public class LearnShapeletOrdersKMeansInit {
    ...
    public void Initialize() {
        ...
        for (int c = 0; c < C; c++) {
            for (int r = 0; r < R; r++) {
                ...
                //GradHistBiasW[c] = 0;
                delta[c] = 2 * rand.nextDouble() ; // Random number between 0 and 1
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        System.out.println("LSO with Kmeans Initialization");
        //main outer directory for Dataset Selection
        String maindirectory = "/home/a3d/Desktop/Shoumik_experiments/dataset/ECML2020/Real/multi/";
        ...
        for (String name : datasets) {
            ...
            String outfile = place + name + "_LearnOrders_Results_kmeans_init.txt";
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LearnShapeletOrdersKMeansInit lso = new LearnShapeletOrdersKMeansInit();
