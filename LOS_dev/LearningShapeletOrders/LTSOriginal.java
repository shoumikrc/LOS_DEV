...
//                }
            ...
            public void iteration(Integer r) {
                try {
                    ...
                    for (int k = 0; k < K; k++) {
                        ...
                        for (int l = 0; l < L[r]; l++) {
                            if (k % 2 == 0) {
                                Shapelets[r][k][l] = Math.sin(2 * Math.PI * f * ((double) l / (double) L[r]));//+ (2*rand.nextDouble()-1 + rand.nextGaussian());
                            } else
                                Shapelets[r][k][l] = Math.cos(2 * Math.PI * f * ((double) l / (double) L[r]));// + (2*rand.nextDouble()-1 + rand.nextGaussian());;
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        for (String name : datasets) {
            ...
            String outfile = place + name + "_LTS_Results_kmeans_init.txt";
            ...
            System.out.println("K  = " + numOfShapelets);
            ...
            ps.print("\n Number of Shapelets: " + numOfShapelets);
            ps.close();
