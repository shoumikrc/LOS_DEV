 ...
 */
public class LearnShapeletOrders {
    ...
    public void Initialize() {
        ...
        for (int c = 0; c < C; c++) {
            for (int r = 0; r < R; r++) {
                ...
                //GradHistBiasW[c] = 0;
                delta[c] = rand.nextDouble() ; // Random number between 0 and 1
                    ...
                    for (int k = 0; k < K; k++) {
                        ...
                        for (int l = 0; l < L[r]; l++) {
                            if (k % 2 == 0) {
                                ...
                                //Shapelets[r][k][l] = Math.sin(2 * Math.PI * f * ((double) l / (double) L[r])) + rand.nextGaussian();
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        String maindirectory = "/home/a3d/Desktop/Shoumik_experiments/dataset/ECML2020/Real/single2/";
        ...
        for (String name : datasets) {
            ...
            String outfile = place + name + "_LearnOrders_Results_random_init.txt";
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LearnShapeletOrders lso = new LearnShapeletOrders();
