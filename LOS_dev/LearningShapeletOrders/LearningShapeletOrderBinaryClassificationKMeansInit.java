...
public class LearningShapeletOrderBinaryClassificationKMeansInit {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        System.out.println("LSO for Binary Classification Kmeans Init");
        ...
        for (String name : datasets) {
            ...
            String outfile = place + name + "_LearnOrders_kmeans_Results.txt";
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LearningShapeletOrderBinaryClassificationKMeansInit lso = new  LearningShapeletOrderBinaryClassificationKMeansInit();
                //lso.runPython();
