...
public void Initialize() throws FileNotFoundException{
	...
	//Logging.println("eta=" + eta + ", maxIter="+ amxIter, LogLevel.DEBUGGING_LOG);
	...
	for(int iter = 0; iter <= maxIter; iter++){
            ...
            if( iter % 200 == 0){
                ...
                //Logging.println("It=" + iter + ", alpha= "+alpha+", lossTrain="+ lossTrain + ", lossTest="+ lossTest  +
                              //", MCRTrain=" + (1 -mcrTrain) + ", MCRTest=" + (1 - mcrTest[0]) //+ ", SVM=" + mcrSVMTest
    ...
    public static void main(String [] args) throws FileNotFoundException, IOException{
        ...
        String maindirectory = "C:\\shoumik\\DABI\\datasets\\TSCProblems2018\\Univariate2018_arff\\LSOBetter\\";
