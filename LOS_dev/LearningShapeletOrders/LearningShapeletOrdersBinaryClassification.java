...
public class LearningShapeletOrdersBinaryClassification {
    ...
    public void Initialize() throws FileNotFoundException {
        ...
        //}
        delta = rand.nextDouble();//Math.random()/10; // Random number between 0 and 1
    ...
    public void PrintGammaParameters(String outputfile) throws FileNotFoundException {
        ...
        //for (int c = 0; c < C; c++) {
        System.out.println("Gamma parameters: " + delta + " " + (1 - delta));
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        System.out.println("LSO for Binary Classification Random Init");
