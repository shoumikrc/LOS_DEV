...
public class LearnShapeletOrdersBaseline2BinaryClassification {
                ...
                //for (int c = 0; c < C; c++) {
                    ...
                    for (int r = 0; r < R; r++) { //here starts for each scale
                        ...
                        for (int k = 0; k < K; k++) {
                            ...
                            gradW_k = dLdY *  M[i][r][k] + regW_kConst * W_k[r][k];
                        ...
                        for (int h = 0; h < H; h++) {
                            gradW_h = dLdY * G[i][r][h] + regW_hConst * W_h[r][h];
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        for (String name : datasets) {
            ...
            for (long seed = 0; seed < numofSeeds; seed++) {
                ...
                //Java class object
                LearnShapeletOrdersBaseline2BinaryClassification  lso = new LearnShapeletOrdersBaseline2BinaryClassification ();
